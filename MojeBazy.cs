...
namespace po
{
    struct MojeBazy
    {
        ...
        public static DateTime PrzykladowaData(int x)
        {
            ...
            data[2] = new DateTime(dzis.Year, dzis.Month + 1, dzis.Day - 29, 16, 30, 00);
            data[3] = new DateTime(dzis.Year, dzis.Month + 1, dzis.Day - 28, 14, 30, 00);
            data[4] = new DateTime(dzis.Year, dzis.Month + 1, dzis.Day - 27, 11, 30, 00);
